        ...
        <div class="col-md-4">
            ...
            <form method="POST" action="/admin/index.php?page=catalogos" class="mb-3">
                ...
                <?php if ($edicion['tipo'] === 'marca'): ?>
                    <a href="/admin/index.php?page=catalogos" class="btn btn-secondary btn-sm">Cancelar</a>
                <?php endif; ?>
            </form>
            <ul class="list-group">
                <?php foreach ($marcas as $fila): ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <span>
                            <a href="/admin/index.php?page=catalogos&editar_tipo=marca&cod=<?php echo (int)$fila['cod']; ?>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="/admin/index.php?page=catalogos&eliminar_tipo=marca&cod=<?php echo (int)$fila['cod']; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                        </span>
                    </li>
                <?php endforeach; ?>
            </ul>
            ...
            <ul class="list-group">
                <?php foreach ($categorias as $fila): ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <?php echo htmlspecialchars($fila['nombre']); ?>
                        <span>
                            <a href="/admin/index.php?page=catalogos&editar_tipo=categoria&cod=<?php echo (int)$fila['cod']; ?>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="/admin/index.php?page=catalogos&eliminar_tipo=categoria&cod=<?php echo (int)$fila['cod']; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                        </span>
                    </li>
                <?php endforeach; ?>
            </ul>
            ...
            <ul class="list-group">
                <?php foreach ($industrias as $fila): ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <?php echo htmlspecialchars($fila['nombre']); ?>
                        <span>
                            <a href="/admin/index.php?page=catalogos&editar_tipo=industria&cod=<?php echo (int)$fila['cod']; ?>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="/admin/index.php?page=catalogos&eliminar_tipo=industria&cod=<?php echo (int)$fila['cod']; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                        </span>
                    </li>
                <?php endforeach; ?>
            </ul>
