            ...
            <div class="card-body">
                <form id="formVendedor" method="POST"
                    ...
                    <?php if ($esEditar): ?>
                        ...
                        <input type="hidden" name="ci" value="<?php echo htmlspecialchars($vendedor['ci'] ?? ''); ?>">
                    <?php endif; ?>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nombres" class="form-control"
                                   value="<?php echo htmlspecialchars($vendedor['nombres'] ?? ''); ?>" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="apPaterno" class="form-control"
                                   value="<?php echo htmlspecialchars($vendedor['apPaterno'] ?? ''); ?>" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="apMaterno" class="form-control"
                                   value="<?php echo htmlspecialchars($vendedor['apMaterno'] ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <?php if ($esEditar): ?>
                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($vendedor['ci'] ?? ''); ?>" readonly>
                            <?php else: ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="email" name="correo" class="form-control"
                                   value="<?php echo htmlspecialchars($vendedor['correo'] ?? ''); ?>" required>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" name="nroCelular" class="form-control"
                                   value="<?php echo htmlspecialchars($vendedor['nroCelular'] ?? ''); ?>" required>
                        </div>
                    </div>
            </div>
        </div>
            ...
            <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <?php if ($esEditar): ?>
                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($vendedor['usuarioCuenta'] ?? ''); ?>" readonly>
                            <?php else: ?>
            ...
            <div class="card-body">
                <?php if ($esEditar): ?>
                    <div class="mb-2 small">
                        ...
                        <strong class="ms-1"><?php echo htmlspecialchars($vendedor['ci'] ?? ''); ?></strong>
                    </div>
                    <div class="mb-2 small">
                        <span class="text-muted">Usuario:</span>
                        <strong class="ms-1"><?php echo htmlspecialchars($vendedor['usuarioCuenta'] ?? ''); ?></strong>
                    </div>
                    <hr>
                <?php endif; ?>
                <div class="d-grid gap-2">
                    <button type="submit" form="formVendedor" class="btn fw-semibold text-white"
