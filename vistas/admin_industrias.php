...
<div class="page-header d-flex align-items-center justify-content-between">
    ...
    <a href="/admin/index.php?page=industrias_crear" class="btn fw-semibold text-white"
                    ...
                    <?php if (empty($industrias)): ?>
                        <tr>
                            <td colspan="3" class="text-center text-muted py-5">
                                ...
                                No hay industrias. <a href="/admin/index.php?page=industrias_crear">Crear la primera</a>
                            </td>
                        </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="/admin/index.php?page=industrias_editar&id=<?php echo (int)$item['cod']; ?>"
