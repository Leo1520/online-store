                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <button class="btn btn-sm btn-outline-danger py-0 px-2" title="Eliminar"
                                    onclick="confirmDelete('la marca <?php echo htmlspecialchars($item['nombre'], ENT_QUOTES); ?>', function(){
                                        window.location='/admin/index.php?page=marcas&eliminar=<?php echo (int)$item['cod']; ?>';
                                    })">
