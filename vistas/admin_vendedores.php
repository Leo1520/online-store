...
<div class="page-header d-flex align-items-center justify-content-between">
    ...
    <a href="index.php?page=vendedores_crear" class="btn fw-semibold text-white"
                    ...
                    <?php if (empty($vendedores)): ?>
                        <tr>
                            <td colspan="6" class="text-center text-muted py-5">
                                ...
                                No hay vendedores. <a href="index.php?page=vendedores_crear">Registrar el primero</a>
                            </td>
                        </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="index.php?page=vendedores_editar&ci=<?php echo urlencode($v['ci']); ?>&usuario=<?php echo urlencode($v['usuarioCuenta']); ?>"
